        ...
        <div className={styles.section}>
            <div className={styles.howWorksSection}>
                ...
                <div className={styles.howWorksTextContainer}>
                    ...
                    <div className={styles.howWorksSubtitle}>Set the time period during which the buyer can get a refund (it can be set to 0). If the buyer burns the token, they won't be able to access the funds, and the seller will have to wait for the set time to withdraw the funds.</div>
